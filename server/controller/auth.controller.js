...
exports.signup = async (req, res) => {
  try {
    const { fname,lname,  email, nationality,age,gender, countryCode,contactNumber, password } = req.body;
    if (!fname || !email || !password) {
      return res.status(400).json({ status: "Success", message: "field is missing in Signup" });
    }
